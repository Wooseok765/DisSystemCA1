...
public class ServiceRegistration {
    ...
    private ServiceRegistration() throws UnknownHostException, IOException {
        jmdns = JmDNS.create(InetAddress.getLocalHost());  // register IP address on network(host)
    ...
    public void registerService(String type, String name, int port, String text) throws IOException {
        ...
        //Returns:
        //new service info 
        ServiceInfo serviceInfo = ServiceInfo.create(type, name, port, text);// 여기서 서비스 정보가 정의됨(for trading)
